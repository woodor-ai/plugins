...
Covers am_common's proj cache + derive_project fallback, no central am-msgd needed:
...
def main():
    ...
    try:
        ...
        try:
            am_common.proj_cache_set(root_a, "my-explicit-proj")
            got = am_common.derive_project(root_a)
        ...
        try:
            got = am_common.derive_project(under_home)
        ...
        try:
            got = am_common.proj_cache_get(root_c)
        ...
        got_star = am_common.validate_proj("*")
        ...
        try:
            proj = am_common.validate_proj("myproj")
            am_common.proj_cache_set(am_common._project_root(root_e), proj)
            got = am_common.derive_project(root_e)
